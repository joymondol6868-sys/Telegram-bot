...
<i>Please include your User ID shown in your profile.</i>`,
    ...
    upgradeLimitTitle: "🚀 Upgrade Daily Limit",
    upgradeLimitIntro: "Invite friends to unlock more ads/day — plus a one-time cash bonus at every milestone below!",
    upgradeLimitCount: "👥 Your Referrals: {count}",
    upgradeLimitActive: "⚡ Active Bonus: +{bonusAds} Ads/day (expires in {daysLeft}d)",
    upgradeLimitNone: "⚡ Active Bonus: None yet — hit your first milestone below!",
    upgradeLimitNext: "🎯 Next Milestone: {left} more referrals to go",
    upgradeLimitMaxed: "🏆 You've unlocked every milestone tier!",
    milestoneRowDone: "✅ {referrals} Referrals — +{bonusAds} Ads/day ({days}d) + ${cashBonus}",
    milestoneRowTodo: "🔒 {referrals} Referrals — +{bonusAds} Ads/day ({days}d) + ${cashBonus}",
    upgradeLimitLink: "🔗 Your referral link:\n{link}",
  },
...
<i>প্রোফাইলে দেখানো User ID উল্লেখ করুন।</i>`,
    ...
    watchAdsEarnBtn: "👁️ বিজ্ঞাপন দেখে আয় করুন",
    walletBtn: "💳 ওয়ালেট ও উইথড্র",
    dashboardBtn: "👤 ড্যাশবোর্ড",
    referralsBtn: "👥 বন্ধুদের আমন্ত্রণ জানান",
    rewardsBtn: "🎁 দৈনিক পুরস্কার",
    videoZoneBtn: "🎬 ভিডিও জোন",
    channelBtn: "📢 পেমেন্ট চ্যানেল",
    settingsBtn: "⚙️ সেটিংস",
    supportBtn: "💬 সাপোর্ট",
    watchAdNowBtn: "🎬 এখনই বিজ্ঞাপন দেখুন",
    upgradeLimitBtn: "🚀 দৈনিক লিমিট বাড়ান (রেফার করুন)",
    backToMainBtn: "🔙 মেইন মেনুতে ফিরুন",

    upgradeLimitTitle: "🚀 দৈনিক লিমিট বাড়ান",
    upgradeLimitIntro: "বন্ধুদের ইনভাইট করে প্রতিদিন আরও বেশি Ads দেখার সুযোগ আনলক করো — সাথে প্রতিটা milestone-এ একবারের জন্য cash bonus!",
    upgradeLimitCount: "👥 তোমার রেফারেল সংখ্যা: {count}",
    upgradeLimitActive: "⚡ সক্রিয় বোনাস: +{bonusAds} Ads/day (মেয়াদ শেষ {daysLeft} দিনে)",
    upgradeLimitNone: "⚡ সক্রিয় বোনাস: এখনো নেই — নিচের প্রথম milestone পূরণ করো!",
    upgradeLimitNext: "🎯 পরবর্তী Milestone: আর {left} জন রেফার করতে হবে",
    upgradeLimitMaxed: "🏆 তুমি সবগুলো milestone আনলক করে ফেলেছো!",
    milestoneRowDone: "✅ {referrals} রেফারেল — +{bonusAds} Ads/day ({days} দিন) + ${cashBonus}",
    milestoneRowTodo: "🔒 {referrals} রেফারেল — +{bonusAds} Ads/day ({days} দিন) + ${cashBonus}",
    upgradeLimitLink: "🔗 তোমার রেফারেল লিংক:\n{link}",
  },
...
<i>कृपया प्रोफ़ाइल में दिखने वाला User ID शामिल करें।</i>`,
    ...
    watchAdsEarnBtn: "👁️ विज्ञापन देखें और कमाएँ",
    walletBtn: "💳 वॉलेट और निकासी",
    dashboardBtn: "👤 डैशबोर्ड",
    referralsBtn: "👥 दोस्तों को आमंत्रित करें",
    rewardsBtn: "🎁 दैनिक इनाम",
    videoZoneBtn: "🎬 वीडियो ज़ोन",
    channelBtn: "📢 पेमेंट चैनल",
    settingsBtn: "⚙️ सेटिंग्स",
    supportBtn: "💬 सहायता",
    watchAdNowBtn: "🎬 अभी विज्ञापन देखें",
    upgradeLimitBtn: "🚀 दैनिक सीमा बढ़ाएँ (रेफ़र करें)",
    backToMainBtn: "🔙 मुख्य मेनू पर वापस",
  },
...
⏱ وقت الاستجابة: <b>24 ساعة</b>`,
    ...
    watchAdsEarnBtn: "👁️ شاهد الإعلانات واكسب",
    walletBtn: "💳 المحفظة والسحب",
    dashboardBtn: "👤 لوحة التحكم",
    referralsBtn: "👥 دعوة الأصدقاء",
    rewardsBtn: "🎁 المكافآت اليومية",
    videoZoneBtn: "🎬 منطقة الفيديو",
    channelBtn: "📢 قناة الدفع",
    settingsBtn: "⚙️ الإعدادات",
    supportBtn: "💬 الدعم",
    watchAdNowBtn: "🎬 شاهد إعلانًا الآن",
    upgradeLimitBtn: "🚀 زيادة الحد اليومي (إحالة)",
    backToMainBtn: "🔙 العودة للقائمة الرئيسية",
  },
...
⏱ Время ответа: <b>24 часа</b>`,
    ...
    watchAdsEarnBtn: "👁️ Смотреть рекламу и зарабатывать",
    walletBtn: "💳 Кошелёк и вывод",
    dashboardBtn: "👤 Личный кабинет",
    referralsBtn: "👥 Пригласить друзей",
    rewardsBtn: "🎁 Ежедневные награды",
    videoZoneBtn: "🎬 Видеозона",
    channelBtn: "📢 Канал для выплат",
    settingsBtn: "⚙️ Настройки",
    supportBtn: "💬 Поддержка",
    watchAdNowBtn: "🎬 Смотреть рекламу сейчас",
    upgradeLimitBtn: "🚀 Увеличить дневной лимит (Рефералы)",
    backToMainBtn: "🔙 Назад в главное меню",
  },
...
⏱ Yanıt süresi: <b>24 saat</b>`,
    ...
    watchAdsEarnBtn: "👁️ Reklam İzle ve Kazan",
    walletBtn: "💳 Cüzdan ve Çekim",
    dashboardBtn: "👤 Panel",
    referralsBtn: "👥 Arkadaş Davet Et",
    rewardsBtn: "🎁 Günlük Ödüller",
    videoZoneBtn: "🎬 Video Bölgesi",
    channelBtn: "📢 Ödeme Kanalı",
    settingsBtn: "⚙️ Ayarlar",
    supportBtn: "💬 Destek",
    watchAdNowBtn: "🎬 Şimdi Reklam İzle",
    upgradeLimitBtn: "🚀 Günlük Limiti Artır (Referans)",
    backToMainBtn: "🔙 Ana Menüye Dön",
  },
...
⏱ جواب: <b>24 گھنٹے میں</b>`,
    ...
    watchAdsEarnBtn: "👁️ اشتہار دیکھیں اور کمائیں",
    walletBtn: "💳 والٹ اور نکاسی",
    dashboardBtn: "👤 ڈیش بورڈ",
    referralsBtn: "👥 دوستوں کو مدعو کریں",
    rewardsBtn: "🎁 روزانہ انعامات",
    videoZoneBtn: "🎬 ویڈیو زون",
    channelBtn: "📢 پیمنٹ چینل",
    settingsBtn: "⚙️ ترتیبات",
    supportBtn: "💬 سپورٹ",
    watchAdNowBtn: "🎬 ابھی اشتہار دیکھیں",
    upgradeLimitBtn: "🚀 روزانہ حد بڑھائیں (ریفر کریں)",
    backToMainBtn: "🔙 مین مینو پر واپس",
  },
...
⏱ ਜਵਾਬ: <b>24 ਘੰਟੇ ਵਿੱਚ</b>`,
    ...
    watchAdsEarnBtn: "👁️ ਇਸ਼ਤਿਹਾਰ ਦੇਖੋ ਅਤੇ ਕਮਾਓ",
    walletBtn: "💳 ਵਾਲਿਟ ਅਤੇ ਕਢਵਾਉਣਾ",
    dashboardBtn: "👤 ਡੈਸ਼ਬੋਰਡ",
    referralsBtn: "👥 ਦੋਸਤਾਂ ਨੂੰ ਸੱਦਾ ਦਿਓ",
    rewardsBtn: "🎁 ਰੋਜ਼ਾਨਾ ਇਨਾਮ",
    videoZoneBtn: "🎬 ਵੀਡੀਓ ਜ਼ੋਨ",
    channelBtn: "📢 ਪੇਮੈਂਟ ਚੈਨਲ",
    settingsBtn: "⚙️ ਸੈਟਿੰਗਾਂ",
    supportBtn: "💬 ਸਹਾਇਤਾ",
    watchAdNowBtn: "🎬 ਹੁਣੇ ਇਸ਼ਤਿਹਾਰ ਦੇਖੋ",
    upgradeLimitBtn: "🚀 ਰੋਜ਼ਾਨਾ ਸੀਮਾ ਵਧਾਓ (ਰੈਫਰ ਕਰੋ)",
    backToMainBtn: "🔙 ਮੁੱਖ ਮੀਨੂ 'ਤੇ ਵਾਪਸ",
  },
...
⏱ Waktu respons: <b>24 jam</b>`,
    ...
    watchAdsEarnBtn: "👁️ Tonton Iklan & Hasilkan",
    walletBtn: "💳 Dompet & Penarikan",
    dashboardBtn: "👤 Dasbor",
    referralsBtn: "👥 Undang Teman",
    rewardsBtn: "🎁 Hadiah Harian",
    videoZoneBtn: "🎬 Zona Video",
    channelBtn: "📢 Saluran Pembayaran",
    settingsBtn: "⚙️ Pengaturan",
    supportBtn: "💬 Dukungan",
    watchAdNowBtn: "🎬 Tonton Iklan Sekarang",
    upgradeLimitBtn: "🚀 Tingkatkan Batas Harian (Referral)",
    backToMainBtn: "🔙 Kembali ke Menu Utama",
  },
...
⏱ Temps de réponse: <b>24 heures</b>`,
    ...
    watchAdsEarnBtn: "👁️ Regarder des pubs et gagner",
    walletBtn: "💳 Portefeuille et retrait",
    dashboardBtn: "👤 Tableau de bord",
    referralsBtn: "👥 Inviter des amis",
    rewardsBtn: "🎁 Récompenses quotidiennes",
    videoZoneBtn: "🎬 Zone vidéo",
    channelBtn: "📢 Canal de paiement",
    settingsBtn: "⚙️ Paramètres",
    supportBtn: "💬 Assistance",
    watchAdNowBtn: "🎬 Regarder une pub maintenant",
    upgradeLimitBtn: "🚀 Augmenter la limite quotidienne (Parrainage)",
    backToMainBtn: "🔙 Retour au menu principal",
  },
...
⏱ Tiempo de respuesta: <b>24 horas</b>`,
    ...
    watchAdsEarnBtn: "👁️ Ver anuncios y ganar",
    walletBtn: "💳 Billetera y retiro",
    dashboardBtn: "👤 Panel",
    referralsBtn: "👥 Invitar amigos",
    rewardsBtn: "🎁 Recompensas diarias",
    videoZoneBtn: "🎬 Zona de video",
    channelBtn: "📢 Canal de pago",
    settingsBtn: "⚙️ Configuración",
    supportBtn: "💬 Soporte",
    watchAdNowBtn: "🎬 Ver anuncio ahora",
    upgradeLimitBtn: "🚀 Aumentar límite diario (Referidos)",
    backToMainBtn: "🔙 Volver al menú principal",
  },
...
⏱ Tempo de resposta: <b>24 horas</b>`,
    ...
    watchAdsEarnBtn: "👁️ Ver anúncios e ganhar",
    walletBtn: "💳 Carteira e saque",
    dashboardBtn: "👤 Painel",
    referralsBtn: "👥 Convidar amigos",
    rewardsBtn: "🎁 Recompensas diárias",
    videoZoneBtn: "🎬 Zona de vídeo",
    channelBtn: "📢 Canal de pagamento",
    settingsBtn: "⚙️ Configurações",
    supportBtn: "💬 Suporte",
    watchAdNowBtn: "🎬 Ver anúncio agora",
    upgradeLimitBtn: "🚀 Aumentar limite diário (Indicações)",
    backToMainBtn: "🔙 Voltar ao menu principal",
  },
};
